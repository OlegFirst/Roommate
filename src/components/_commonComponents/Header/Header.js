  ...
  return (    
		<header className="header">
			...
			<div className="header__buttons">
				<Button className="button-outline" variant="outline-secondary" onClick={() => history.push('/advertisement')}>Main</Button>
				...
				<Dropdown className="header__dropdown">
					...
					<Dropdown.Menu>
						...
						<Dropdown.Item href="/create-advertisement">Create advertisement</Dropdown.Item>
